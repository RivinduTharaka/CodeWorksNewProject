...
const BlogSec2 = () => {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    const cacheKey = 'blogs_country_2';
    ...
    try {
      // Step 1: Fetch blog_countries entries for country_id = 2 and is_active = true
      const blogCountriesResponse = await selectData('blog_countries', { country_id: 2, is_active: true });
          ...
          >
            ...
            <Box sx={{ position: "relative" }}>
              ...
              >
                ...
                >
                  {blog.category_id === 1 ? "Backend API" : "Unknown Category"}
                </Typography>
              </Box>
            </Box>
