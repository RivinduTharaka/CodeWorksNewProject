...
const AUNavbar = () => {
  ...
  const [selectedCountry, setSelectedCountry] = useState(() => {
    ...
    return countries.find(country => country.route === `/${currentPath}`) || countries.find(country => country.name === "Australia");
  });
  ...
  const isTargetPage =
    ...
    location.pathname === '/au/solution' ||
    location.pathname === '/au/vendors' ||
    location.pathname === '/au/contact' ||
    location.pathname === '/au/events' ||
    location.pathname === '/au/workshops' ||
    location.pathname === '/au/technical-support' ||
    location.pathname === '/au/professional-services' ||
    location.pathname === '/au/trainings' ||
    location.pathname === '/au/blog' ||
    location.pathname === '/au/press-&-media' ||
    location.pathname === '/au/global-coverage' ||
    location.pathname === '/au/leadership' ||
    location.pathname === '/au/careers' ||
    location.pathname === '/au/about';
  ...
  useEffect(() => {
    const currentPath = location.pathname.split('/')[1] || '';
    const matchedCountry = countries.find(country => country.route === `/${currentPath}`) || countries.find(country => country.name === "Australia");
    ...
    <ThemeProvider theme={theme}>
      ...
      >
        <FuturisticAppBar position="fixed" isTargetPage={isTargetPage} isScrolled={isScrolled}>
          <FuturisticToolbar>
            <Link to="/au" style={{ padding: "10px 0 10px 10px", display: "flex", alignItems: "center" }}>
              <motion.img
            ...
            {isMobile ? (
                    ...
                    {drawerOpen && (
                      ...
                      >
                        ...
                        <List sx={{ padding: "0 1.5rem" }}>
                          <ListItem component={Link} to="/au/solution" onClick={() => setDrawerOpen(false)}>
                            <ListItemText primary="Solutions" primaryTypographyProps={{ style: { color: "#E0E0E0", fontFamily: "'Orbitron', sans-serif" } }} />
                          </ListItem>
                          <ListItem component={Link} to="/au/vendors" onClick={() => setDrawerOpen(false)}>
                          ...
                          >
                            <MobileNavLinkContainer>
                              ...
                              />
                              <MobileNeonHoverEffect active={location.pathname === '/au/events' || location.pathname === '/au/workshops'} />
                            </MobileNavLinkContainer>
                            {eventsSubmenuOpen ? (
                          ...
                          <ListItem component={Link} to="/au/portal" onClick={() => setDrawerOpen(false)}>
              ...
              <ButtonContainer>
                <FuturisticButton
                  component={Link}
                  to="/au/solution"
                  active={location.pathname === "/au/solution"}
                  isTargetPage={isTargetPage}
                  isScrolled={isScrolled}
                >
                  Solutions
                  <NeonHoverEffect active={location.pathname === "/au/solution"} />
                </FuturisticButton>

                <FuturisticButton
                  component={Link}
                  to="/au/vendors"
                  active={location.pathname === "/au/vendors"}
                  isTargetPage={isTargetPage}
                  isScrolled={isScrolled}
                >
                  Vendors
                  <NeonHoverEffect active={location.pathname === "/au/vendors"} />
                </FuturisticButton>
                ...
                >
                  <DropdownButton
                    active={location.pathname === "/au/events" || location.pathname === "/au/workshops"}
                    isTargetPage={isTargetPage}
                    isScrolled={isScrolled}
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      ...
                      <NeonHoverEffect active={location.pathname === "/au/events" || location.pathname === "/au/workshops"} />
                    </Box>
                  </DropdownButton>
                  ...
                  >
                    <FuturisticMenuItem onClick={handleEventsClose} component={Link} to="/au/events">
                      Events | Webinars
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleEventsClose} component={Link} to="/au">
                      Workshops
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/au">
                      Technical Support
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/au">
                      Professional Services
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/au/trainings">
                      Trainings
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  <DropdownButton
                    active={location.pathname === "/au/blog" || location.pathname === "/au/press-&-media"}
                    isTargetPage={isTargetPage}
                    isScrolled={isScrolled}
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      ...
                      <NeonHoverEffect active={location.pathname === "/au/blog" || location.pathname === "/au/press-&-media"} />
                    </Box>
                  </DropdownButton>
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleNewsClose} component={Link} to="/au/blog">
                      Blogs
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleNewsClose} component={Link} to="/au">
                      Press & Media
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/au/about">
                      About Us
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/au/global-coverage">
                      Global Coverage
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/au/leadership">
                      Leadership
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/au/careers">
                      Careers
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/au/contact">
                      Contact Us
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
