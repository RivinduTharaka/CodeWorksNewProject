...
const CustomButton = styled(Button)(({ isTargetPage, isScrolled, active }) => ({
  ...
  '& span': {
    width: active ? '100%' : '0%',
    height: '2px',
    backgroundColor: isTargetPage && !isScrolled ? '#ffffff' : theme.palette.primary.main,
    transition: 'width 0.3s ease-in-out',
  },
  '&:hover > span': {
    width: '100%',
...
const ContactButton = styled(Button)(({ isScrolled }) => ({
  backgroundColor: isScrolled ? theme.palette.primary.main : 'rgba(21, 101, 192, 0.8)',
  color: '#ffffff',
  fontSize: '0.9rem',
  fontWeight: '500',
  textTransform: 'none',
  ...
  '&:hover': {
    backgroundColor: isScrolled ? theme.palette.primary.dark : 'rgba(21, 101, 192, 0.4)',
  },
}));
        ...
        <CustomToolbar>
          ...
          {isMobile ? (
                  ...
                  {drawerOpen && (
                    ...
                    >
                      ...
                      <List sx={{ padding: '0 1.5rem' }}>
                        ...
                        <ListItem component={Link} to="/events" onClick={() => setDrawerOpen(false)}>
            ...
            <ButtonContainer>
              ...
              >
                News
                <HoverEffect active={location.pathname === '/news'} />
              </CustomButton>
