...
const MalNavbar = () => {
  ...
  const isTargetPage =
    ...
    location.pathname === '/my/solution' ||
    location.pathname === '/my/vendors' ||
    location.pathname === '/my/contact' ||
    location.pathname === '/my/events' ||
    location.pathname === '/my/workshops' ||
    location.pathname === '/my/technical-support' ||
    location.pathname === '/my/professional-services' ||
    location.pathname === '/my/trainings' ||
    location.pathname === '/my/blog' ||
    location.pathname === '/my/press-&-media' ||
    location.pathname === '/my/global-coverage' ||
    location.pathname === '/my/leadership' ||
    location.pathname === '/my/careers' ||
    location.pathname === '/my/about';
    ...
    <ThemeProvider theme={theme}>
      ...
      >
        <FuturisticAppBar position="fixed" isTargetPage={isTargetPage} isScrolled={isScrolled}>
          <FuturisticToolbar>
            <Link to="/my" style={{ padding: "10px 0 10px 10px", display: "flex", alignItems: "center" }}>
              <motion.img
            ...
            {isMobile ? (
                    ...
                    {drawerOpen && (
                      ...
                      >
                        ...
                        <List sx={{ padding: "0 1.5rem" }}>
                          <ListItem component={Link} to="/my/solution" onClick={() => setDrawerOpen(false)}>
                            <ListItemText primary="Solutions" primaryTypographyProps={{ style: { color: "#E0E0E0", fontFamily: "'Orbitron', sans-serif" } }} />
                          </ListItem>
                          <ListItem component={Link} to="/my/vendors" onClick={() => setDrawerOpen(false)}>
                          ...
                          >
                            <MobileNavLinkContainer>
                              ...
                              />
                              <MobileNeonHoverEffect active={location.pathname === '/my/events' || location.pathname === '/my/workshops'} />
                            </MobileNavLinkContainer>
                            {eventsSubmenuOpen ? (
                          ...
                          <ListItem component={Link} to="/my/portal" onClick={() => setDrawerOpen(false)}>
              ...
              <ButtonContainer>
                <FuturisticButton
                  component={Link}
                  to="/my/solution"
                  active={location.pathname === "/my/solution"}
                  isTargetPage={isTargetPage}
                  isScrolled={isScrolled}
                >
                  Solutions
                  <NeonHoverEffect active={location.pathname === "/my/solution"} />
                </FuturisticButton>

                <FuturisticButton
                  component={Link}
                  to="/my/vendors"
                  active={location.pathname === "/my/vendors"}
                  isTargetPage={isTargetPage}
                  isScrolled={isScrolled}
                >
                  Vendors
                  <NeonHoverEffect active={location.pathname === "/my/vendors"} />
                </FuturisticButton>
                ...
                >
                  <DropdownButton
                    active={location.pathname === "/my/events" || location.pathname === "/my/workshops"}
                    isTargetPage={isTargetPage}
                    isScrolled={isScrolled}
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      ...
                      <NeonHoverEffect active={location.pathname === "/my/events" || location.pathname === "/my/workshops"} />
                    </Box>
                  </DropdownButton>
                  ...
                  >
                    <FuturisticMenuItem onClick={handleEventsClose} component={Link} to="/my/events">
                      Events | Webinars
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleEventsClose} component={Link} to="/my">
                      Workshops
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/my">
                      Technical Support
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/my">
                      Professional Services
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/my/trainings">
                      Trainings
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  <DropdownButton
                    active={location.pathname === "/my/blog" || location.pathname === "/my/press-&-media"}
                    isTargetPage={isTargetPage}
                    isScrolled={isScrolled}
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      ...
                      <NeonHoverEffect active={location.pathname === "/my/blog" || location.pathname === "/my/press-&-media"} />
                    </Box>
                  </DropdownButton>
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleNewsClose} component={Link} to="/my/blog">
                      Blogs
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleNewsClose} component={Link} to="/my">
                      Press & Media
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/my/about">
                      About Us
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/my/global-coverage">
                      Global Coverage
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/my/leadership">
                      Leadership
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/my/careers">
                      Careers
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/my/contact">
                      Contact Us
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
