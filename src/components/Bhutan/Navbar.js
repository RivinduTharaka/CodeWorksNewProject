...
const BtNavbar = () => {
  ...
  const isTargetPage =
    location.pathname === '/bt' ||
    location.pathname === '/bt/solution' ||
    location.pathname === '/bt/vendors' ||
    location.pathname === '/bt/contact' ||
    location.pathname === '/bt/events' ||
    location.pathname === '/bt/workshops' ||
    location.pathname === '/bt/technical-support' ||
    location.pathname === '/bt/professional-services' ||
    location.pathname === '/bt/trainings' ||
    location.pathname === '/bt/blog' ||
    location.pathname === '/bt/press-&-media' ||
    location.pathname === '/bt/global-coverage' ||
    location.pathname === '/bt/leadership' ||
    location.pathname === '/bt/careers' ||
    location.pathname === '/bt/about';
    ...
    <ThemeProvider theme={theme}>
      ...
      >
        <FuturisticAppBar position="fixed" isTargetPage={isTargetPage} isScrolled={isScrolled}>
          <FuturisticToolbar>
            <Link to="/bt" style={{ padding: "10px 0 10px 10px", display: "flex", alignItems: "center" }}>
              <motion.img
            ...
            {isMobile ? (
                    ...
                    {drawerOpen && (
                      ...
                      >
                        ...
                        <List sx={{ padding: "0 1.5rem" }}>
                          <ListItem component={Link} to="/bt/solution" onClick={() => setDrawerOpen(false)}>
                            <ListItemText primary="Solutions" primaryTypographyProps={{ style: { color: "#E0E0E0", fontFamily: "'Orbitron', sans-serif" } }} />
                          </ListItem>
                          <ListItem component={Link} to="/bt/vendors" onClick={() => setDrawerOpen(false)}>
                          ...
                          >
                            <MobileNavLinkContainer>
                              ...
                              />
                              <MobileNeonHoverEffect active={location.pathname === '/bt/events' || location.pathname === '/bt/workshops'} />
                            </MobileNavLinkContainer>
                            {eventsSubmenuOpen ? (
                          ...
                          <ListItem component={Link} to="/bt/portal" onClick={() => setDrawerOpen(false)}>
              ...
              <ButtonContainer>
                <FuturisticButton
                  component={Link}
                  to="/bt/solution"
                  active={location.pathname === "/bt/solution"}
                  isTargetPage={isTargetPage}
                  isScrolled={isScrolled}
                >
                  Solutions
                  <NeonHoverEffect active={location.pathname === "/bt/solution"} />
                </FuturisticButton>

                <FuturisticButton
                  component={Link}
                  to="/bt/vendors"
                  active={location.pathname === "/bt/vendors"}
                  isTargetPage={isTargetPage}
                  isScrolled={isScrolled}
                >
                  Vendors
                  <NeonHoverEffect active={location.pathname === "/bt/vendors"} />
                </FuturisticButton>
                ...
                >
                  <DropdownButton
                    active={location.pathname === "/bt/events" || location.pathname === "/bt/workshops"}
                    isTargetPage={isTargetPage}
                    isScrolled={isScrolled}
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      ...
                      <NeonHoverEffect active={location.pathname === "/bt/events" || location.pathname === "/bt/workshops"} />
                    </Box>
                  </DropdownButton>
                  ...
                  >
                    <FuturisticMenuItem onClick={handleEventsClose} component={Link} to="/bt/events">
                      Events | Webinars
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleEventsClose} component={Link} to="/bt">
                      Workshops
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/bt">
                      Technical Support
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/bt">
                      Professional Services
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleServicesClose} component={Link} to="/bt/trainings">
                      Trainings
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  <DropdownButton
                    active={location.pathname === "/bt/blog" || location.pathname === "/bt/press-&-media"}
                    isTargetPage={isTargetPage}
                    isScrolled={isScrolled}
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                      ...
                      <NeonHoverEffect active={location.pathname === "/bt/blog" || location.pathname === "/bt/press-&-media"} />
                    </Box>
                  </DropdownButton>
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleNewsClose} component={Link} to="/bt/blog">
                      Blogs
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleNewsClose} component={Link} to="/bt">
                      Press & Media
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
                ...
                >
                  ...
                  <FuturisticMenu
                    ...
                    transformOrigin={{ vertical: "top", horizontal: "left" }}
                  >
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/bt/about">
                      About Us
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/bt/global-coverage">
                      Global Coverage
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/bt/leadership">
                      Leadership
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/bt/careers">
                      Careers
                    </FuturisticMenuItem>
                    <FuturisticMenuItem onClick={handleAboutClose} component={Link} to="/bt/contact">
                      Contact Us
                    </FuturisticMenuItem>
                  </FuturisticMenu>
                </div>
